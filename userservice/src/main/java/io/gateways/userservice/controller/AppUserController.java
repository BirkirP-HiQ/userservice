package io.gateways.userservice.controller;
...
import io.gateways.userservice.service.AppUserService;
import lombok.Data;
...
public class AppUserController {
    ...
    public ResponseEntity<AppRole>saveRole(@RequestBody AppRole role){
        ...
        return ResponseEntity.created(uri).body(userService.saveAppRole(role));
    }
